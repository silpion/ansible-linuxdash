...
Vagrant.configure(VAGRANT_API_VERSION) do |config|
  ...
  config.vm.define :ansiblelinuxdashtest do |d|

    d.vm.hostname = 'ansiblelinuxdashtest'
    ...
    d.vm.provider :virtualbox do |v|
      ...
      v.customize [ 'modifyvm', :id, '--name', 'ansiblelinuxdashtest', '--memory', '512', '--cpus', '1' ]
    end
